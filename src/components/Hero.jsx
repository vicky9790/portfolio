      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <h2 className="hero-roles reveal" style={{ animationDelay: '0.3s' }}>
            AI & Full Stack Developer <span className="divider">|</span> Associate Developer @ ZoflowX <span className="divider">|</span> Problem Solver
          </h2>
          ...
          <div className="hero-actions reveal" style={{ animationDelay: '0.6s' }}>
            <a href={resumePdf} className="btn btn-primary" download="Vignesh_P_Associate_Developer_Resume.pdf">
              <Download size={18} />
